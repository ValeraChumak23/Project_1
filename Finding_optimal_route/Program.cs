...
namespace Finding_the_optimal_route
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string filePath = System.IO.Path.Combine(directoryPath, "Matrix.xlsx"); // Путь к файлу с матрицей смежности
            ...
            Finalpeaks(adjacencyMatrix, final_peaks, peaks_level_0);
            ...
            Definingmoves(list_moves_player_1, list_moves_player_2, adjacencyMatrix);
        ...
        static void Finalpeaks(int[,] matrix, Dictionary<int, int> final_peaks, List<int> level_0)
        {
        ...
        static void Definingmoves(List<string> player_1, List<string> player_2, int[,] matrix)
        {
